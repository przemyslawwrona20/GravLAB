...
public class GBC extends GridBagConstraints {
	/**
	 * Tworzy obiekt typu GBC z podanymi wartoœciami gridx i gridy oraz
	...
	/**
	 * Tworzy obiekt typu GBC z podanymi wartoœciami gridx, gridy, gridwidth i
	 ...
	 *            wspó³rzêdna gridy
	 * @param gridwidth
	 *            liczba zajmowanych komórek w poziomie
	 * @param gridheight
	 *            liczba zajmowanych komórek w pionie
	 */
	 ...
	 * 
	 * @param top
	 *            odstêp od górnej krawêdzi
	 * @param left
	 *            odstêp od lewej krawêdzi
	 * @param bottom
	 *            odstêp od dolnej krawêdzi
	 * @param right
	 *            odstêp od prawej krawêdzi
	 ...
	 * 
	 * @param ipadx
	 *            dope³nienie wewnêtrzne poziome
	 * @param ipady
	 *            dope³nienie wewnêtrzne pionowe
	 * @return obiekt do dalszej modyfikacji
	 */
